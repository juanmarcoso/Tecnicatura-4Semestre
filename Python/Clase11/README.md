...
```sh
    git clone https://..
    cd app
    python3 -m venv env # Se debe crear el entorno virtual, ese no se comparte desde GitHub
    source env/bin/activate # Se activa el entorno virtual en linux
    env\Scripts\activate # Se activa el entorno virtual en Windows
    pip3 install -r requirements.txt # Instala las dependencias el -r significa reutilizar el archivo
